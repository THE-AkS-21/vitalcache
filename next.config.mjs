                ...
                headers: [
                    ...
                    },
                    {
                        ...
                        value: [
                            ...
                            `connect-src 'self' ${process.env.NEXT_PUBLIC_API_URL ?? 'http://localhost:8080'} http://localhost:8080 https://accounts.google.com ${process.env.NODE_ENV !== 'production' ? 'ws: wss:' : ''}`,
