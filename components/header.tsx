 ...
 *
 * No hooks, no state, no browser APIs → pure Server Component.
 * Removing 'use client' means this renders on the server as plain HTML.
 * The search input is a plain form element; any interactivity is added
 * via a separate client island only when needed.
 */
