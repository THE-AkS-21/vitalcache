      ...
      <aside className="h-screen sticky top-0 border-r bg-white/80 backdrop-blur-xl z-50 flex flex-col">
        <div className="p-6">
          ...
          <nav className="space-y-2">
            <NavItem href="/dashboard" label="Dashboard" icon={Icons.activity} />
            <NavItem href="/patients" label="Patients" icon={Icons.patients} />
            <NavItem href="/prescriptions" label="Prescriptions" icon={Icons.pill} />
            <NavItem href="/medicines" label="Medicines" icon={Icons.pill} />
            <NavItem href="/certificates" label="Certificates" icon={Icons.file} />
            <NavItem href="/bundles" label="Bundles" icon={Icons.add} />
